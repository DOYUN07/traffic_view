...
const SignalAPI = {
  // 공공데이터포털(data.go.kr) 인증키. config.local.js 에서 window.SIGNAL_API_KEY 로 주입합니다.
  // 키가 없으면 실시간 연동이 실패해 자동으로 시뮬레이션 모드로 동작합니다. (config.example.js 참고)
  API_KEY: (typeof window !== "undefined" && window.SIGNAL_API_KEY) || "",
